...
@testset "GeoAxis axis parity surface" begin
    ...
    for attr in (:title, :subtitle, :xlabel, :ylabel,
            :xticklabelplacement, :yticklabelplacement,
            :spinevisible, :spinewidth, :spinecolor,
            :xgridvisible, :xgridwidth, :xgridcolor,
            :xticksvisible, :xtickwidth, :xticksize, :xtickcolor,
            :xticklabelsvisible, :xticklabelpad, :xticklabelrotation)
    ...
    for f in (Makie.xlims!, Makie.ylims!, Makie.limits!,
            Makie.tightlimits!, Makie.autolimits!, Makie.reset_limits!)
        @test f isa Function
    end
